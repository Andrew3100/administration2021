    ...
    <div class='row'>
        ...
        <div class="container">
            <div class="row">
                ...
                <a title="Добавить запись" href="add.php?table='.gpr().'"><svg style="width: 35px; height: 35px; color: #28a444" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle-fill" viewBox="0 0 16 16">
